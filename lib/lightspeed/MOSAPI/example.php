...
$mosapi = new MOSAPICall("c2605a32b2c5480acec7dd0894fe90f3f0a2f7b1aff031dd398676d33a3d6df5","94275");
...
$item_response_xml = $mosapi->makeAPICall("Account.Item","Read",null);
print_r($item_response_xml);die(); 
